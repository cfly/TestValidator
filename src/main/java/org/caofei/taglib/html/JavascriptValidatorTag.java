 ...
 * under the License.
 */
package org.caofei.taglib.html;
...
public class JavascriptValidatorTag extends BodyTagSupport {
     ...
     */
    protected String bundle = null;//Globals.MESSAGES_KEY;
...
*/
        ...
        if (form != null) {
            if ("true".equalsIgnoreCase(dynamicJavascript)) {
                results.append(this.createDynamicJavascript(resources,
                        locale, form));
...
*/
        ...
        final String methods =
            this.createMethods(actions, this.stopOnError());
...
*/
    ...
    public void release() {
        super.release();
        bundle = null;//Globals.MESSAGES_KEY;
        formName = null;
        jsFormName = null;
        page = 0;
        methodName = null;
    ...
    private boolean isXhtml() {
        return false;//TagUtils.getInstance().isXhtml(this.pageContext);
    }
